...
create table public.tricks (
  ...
  practice_steps text[] not null default '{}',
  common_mistakes text[] not null default '{}',
  safety_notes text[] not null default '{}',
  coach_comment text not null default '',
  knowledge_status text not null default 'draft' check (knowledge_status in ('draft', 'reviewing', 'reviewed')),
  knowledge_reviewed_by text not null default '',
  knowledge_source_urls text[] not null default '{}',
  show_knowledge_sources boolean not null default false,
